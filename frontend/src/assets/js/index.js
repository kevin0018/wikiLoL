...
document.addEventListener("DOMContentLoaded", () => {
    ...
    searchForm.addEventListener("submit", function (event) {
        ...
        window.location.href = `/src/pages/account.html?region=${encodeURIComponent(selectedRegion)}&gameName=${encodeURIComponent(gameName)}&tagLine=${encodeURIComponent(tagLine)}`;
    });
});